...
PAYTECH_API_KEY = "b1eb4d11f8b411b35b53e69bcd5525ee6a76d726e8b9d835307f57b69cfd8489" 
PAYTECH_SECRET_KEY = "6a845d58ca0ba02b57829b4a3a4e9fa449bc8a7e7b7822d93f2bd8c7fb7fd94b"
...
def requete_paiement_paytech(item_name, price, success_url="http://localhost:8501"):
    headers = {"Accept": "application/json", "Content-Type": "application/json", "API_KEY": PAYTECH_API_KEY, "API_SECRET": PAYTECH_SECRET_KEY}
    payload = {"item_name": item_name, "item_price": price, "currency": "XOF", "ref_command": f"CMD-{secrets.token_hex(4).upper()}", "command_name": "Abonnement MétalSuivi Premium", "env": "test", "success_url": success_url, "cancel_url": success_url}
    try:
